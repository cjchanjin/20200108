...
public class EmployeeServiceImpl extends DAO implements EmployeeService {
	...
	public int insert(EmployeeDto dto) throws SQLException {
		...
		psmt.setInt(1, dto.getEmployee_id()); 	//1 -> 첫번째 물음표에 대응된다
